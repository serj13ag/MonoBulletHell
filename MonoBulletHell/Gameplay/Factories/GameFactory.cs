...
{
    Ship CreateShip();
    Enemy CreateEnemy(PathData path);
}
...
public class GameFactory : IGameFactory
{
    ...
    public Enemy CreateEnemy(PathData path)
    {
        var enemy = new Enemy(_debugService, _timeService, _bulletService, _contentService, path);
        return enemy;
    }
}